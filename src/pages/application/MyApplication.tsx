...
const Index = () => {
  ...
  const tableProps = useTable<App.ListMyAppRequest, App.ApplicationVo>(
    listMyApplication,
    initialRequestParams
  );
  const { fetchData } = tableProps;

  const columns = useMemo<DataTableColumn<App.ApplicationVo>[]>(
    () => [
  ...
  return (
    <Table<App.ListMyAppRequest, App.ApplicationVo>
      {...tableProps}
      columns={columns}
    />
  );
