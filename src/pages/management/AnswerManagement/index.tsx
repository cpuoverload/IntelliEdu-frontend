...
const Index = () => {
  ...
  const tableProps = useTable<Answer.ListAnswerRequest, Answer.AnswerRecordVo>(
    listAnswerRecord,
    initialRequestParams
  );
  const { requestParams, setRequestParams, fetchData } = tableProps;

  const columns = useMemo<DataTableColumn<Answer.AnswerRecordVo>[]>(
    () => [
  ...
  return (
    <>
      ...
      <Table<Answer.ListAnswerRequest, Answer.AnswerRecordVo>
        {...tableProps}
        columns={columns}
      />
    </>
